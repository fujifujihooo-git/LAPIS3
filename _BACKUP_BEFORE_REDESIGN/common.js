...
function renderUserStatus(session) {
    ...
    userArea.innerHTML = `
        <span style="color: #64748b;">ログイン中: <strong>${session.staff_name}</strong> 様</span>
        <button type="button" class="logout-btn" onclick="logout()">ログアウト</button>
    `;

    headerTier2.appendChild(userArea);
}
